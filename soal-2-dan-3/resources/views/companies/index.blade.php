                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    <div class="flex items-center justify-between">
                        ...
                        @if (!is_null($companies))
                            <a href="{{ route('companies.show', $companies->id) }}">Ubah Data Perusahaan</a>
                        @endif
                    </div>
                            ...
                            <div class="w-full md:w-1/2">
                                <div class="flex items-center justify-between gap-3">
                                    <div class="mt-5">
                                        ...
                                        <p class="text-lg text-white">{{ $companies->name }}</p>
                                    </div>
                                    <div class="mt-5">
                                        <h3 class="text-sm text-gray-500">Alamat Perusahaan</h3>
                                        <p class="text-lg text-white">{{ $companies->address }}</p>
                                    </div>
                                </div>
                                <div class="mt-5">
                                    <h3 class="text-sm text-gray-500">Tagline Perusahaan</h3>
                                    <p class="text-lg text-white">{{ $companies->tagline }}</p>
                                </div>
                            </div>

                            <div class="w-full md:w-1/2">
                                @if (!is_null($companies->logo))
                                    <div class="flex items-center justify-center">
                                        <img src="/storage/images/{{ $companies->logo }}" alt="{{ $companies->name }}"
